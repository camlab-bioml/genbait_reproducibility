...
def load_and_aggregate_data(dataset_path, components_range):
    ...
    ga_data = pickle.load(open(os.path.join(dataset_path, 'nmf_scores_ga.pkl'), 'rb'))
    random_data = pickle.load(open(os.path.join(dataset_path, 'nmf_scores_random.pkl'), 'rb'))
    ml_data = pickle.load(open(os.path.join(dataset_path, 'nmf_scores_ml.pkl'), 'rb'))
...
save_path = 'plots'
plt.savefig(os.path.join(save_path, 'nmf_scores_comparison_ordered.png'), dpi=300)
plt.savefig(os.path.join(save_path, 'nmf_scores_comparison_ordered.svg'), dpi=300)
plt.savefig(os.path.join(save_path, 'nmf_scores_comparison_ordered.pdf'), dpi=300)
plt.clf()