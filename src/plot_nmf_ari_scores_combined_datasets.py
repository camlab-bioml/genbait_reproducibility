...
def load_and_aggregate_data(dataset_path, components_range):
    ...
    ga_data = pickle.load(open(os.path.join(dataset_path, 'nmf_scores_ari_ga.pkl'), 'rb'))
    random_data = pickle.load(open(os.path.join(dataset_path, 'nmf_scores_ari_random.pkl'), 'rb'))
    ml_data = pickle.load(open(os.path.join(dataset_path, 'nmf_scores_ari_ml.pkl'), 'rb'))
...
# plt.xlabel("Methods")
plt.ylabel("NMF ARI score", fontsize=16)
...
save_path = 'plots'
plt.savefig(os.path.join(save_path, 'nmf_scores_ari_comparison_ordered.png'), dpi=300)
plt.savefig(os.path.join(save_path, 'nmf_scores_ari_comparison_ordered.svg'), dpi=300)
plt.savefig(os.path.join(save_path, 'nmf_scores_ari_comparison_ordered.pdf'), dpi=300)
plt.clf()