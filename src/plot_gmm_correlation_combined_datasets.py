...
results_file1 = '/Users/vesalkasmaeifar/vesal/PhD_Project/cell map/scripts/Bait selection/snakemake original gradient penalty/plots/gmm_results.pkl'
results_file2 = '/Users/vesalkasmaeifar/vesal/PhD_Project/cell map/scripts/Bait selection/snakemake RNA Bodies gradient penalty/plots/gmm_results.pkl'
...
ax.set_ylabel('GMM mean Pearson correlation score', fontsize=16)
legend_handles = [
...
plt.savefig('plots/gmm_correlation_comparison.png', dpi=300)
plt.savefig('plots/gmm_correlation_comparison.svg', dpi=300)
plt.savefig('plots/gmm_correlation_comparison.pdf', dpi=300)
plt.clf()