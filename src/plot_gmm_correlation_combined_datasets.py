...
def plot_gmm_combined(dataset_files, save_path, output_prefix):
    """
    Loads GMM mean Pearson correlation results, performs statistical analysis, and generates boxplot visualization.

    Args:
        dataset_files (list): List of dataset file paths containing GMM correlation results.
        output_prefix (str): Prefix for saving output files (e.g., "plots/gmm_correlation").
    """
    ...
    colors = ['#F7941D', '#009444', '#FF5733']  # Colors for datasets 1, 2, 3
    ...
    ax.set_ylabel('GMM mean Pearson correlation score', fontsize=18)
