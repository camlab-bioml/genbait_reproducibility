...
# print(list(first_60_items.keys()))
...
def baits_with_most_preys(saint_filepath, original_baits_filepath, num_baits):
    # Load the datasets
    ...
    # Select the top N baits
    selected_baits = list(islice(sorted_bait_prey_counts.keys(), num_baits))

    return selected_baits
